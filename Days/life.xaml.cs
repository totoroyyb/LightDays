...
namespace Days
{
    ...
    public sealed partial class life : Page
    {
        ...
        public life()
        {
            ...
            eventList = EventsManager.getLifeEvents();
        }
        ...
        private void ConfirmButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            EventsManager.lifeEvents.RemoveAt(index);
        ...
        private void EditEvent_Click(object sender, RoutedEventArgs e)
        {
            ...
            Events editedEvent = EventsManager.lifeEvents[itemIndex];

            EditedEvent.SetEditedEvent(editedEvent);

            SelectedFold.selectedFoldIndex = FoldIndexConstants.lifeEvent;
