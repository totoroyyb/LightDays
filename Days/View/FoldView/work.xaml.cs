...
namespace Days
{
    ...
    public sealed partial class work : Page
    {
        ...
        private void ConfirmButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            EventsManager.workEvents.RemoveAt(index);
        ...
        private void EditEvent_Click(object sender, RoutedEventArgs e)
        {
            ...
            Events editedEvent = EventsManager.workEvents[itemIndex];

            EditedEvent.SetEditedEvent(editedEvent);

            SelectedFold.selectedFoldIndex = FoldIndexConstants.workEvent;
