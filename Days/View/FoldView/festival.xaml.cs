...
namespace Days
{
    ...
    public sealed partial class festival : Page
    {
        ...
        public festival()
        {
            ...
            eventList = EventsManager.getFestivalEvents();
        }
        ...
        private void ConfirmButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            EventsManager.festivalEvents.RemoveAt(index);
        ...
        private void EditEvent_Click(object sender, RoutedEventArgs e)
        {
            ...
            Events editedEvent = EventsManager.festivalEvents[itemIndex];

            EditedEvent.SetEditedEvent(editedEvent);

            SelectedFold.selectedFoldIndex = FoldIndexConstants.festivalEvent;
