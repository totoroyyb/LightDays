...
namespace Days
{
    ...
    public sealed partial class study : Page
    {
        ...
        public study()
        {
            ...
            eventList = EventsManager.getStudyEvents();
        }
        ...
        private void ConfirmButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            EventsManager.studyEvents.RemoveAt(index);
        ...
        private void EditEvent_Click(object sender, RoutedEventArgs e)
        {
            ...
            Events editedEvent = EventsManager.studyEvents[itemIndex];

            EditedEvent.SetEditedEvent(editedEvent);

            SelectedFold.selectedFoldIndex = FoldIndexConstants.studyEvent;
